...
public class Controller : MonoBehaviour
{
    ...
    public string[,] mineralList = new string[40,11]
                                    {{"Anfibólio", "5 - 6", "3.10", "Inossilicatos        (cadeia dupla)", "Essencialmente hidroxos de Ca, Mg e Fe", "Ortorrômbico, Monoclínico", "Translúcido", "Perfeita[2]{110}", "Incolor/váriado", "Não-metálico", "Branco, verde, preto. Prismáticos, quebradiços, fibrosos, colunares(amianto). Ex:Hornblenda"}, 
                                    ...
                                    {"Bauxita", "1 - 3.5", "2.25", "Hidróxido", "Misturas de hidróxos de Al", "Monoclínico", "Opáco", "Perfeita[1]", "Laranja", "Não-metálico", "Ex. Gibbsita. Amarelo, castanho. Terroso, semelhante a argila "}, 
                                    ...
                                    {"Epídoto", "6 - 7", "3.40", "Sorossilicatos", "Ca2(Al, Fe)   Al2O(SiO4)(Si2O7)  (OH)", "Monoclínico", "Translúcido", "Perfeita[2]", "Incolor", "Não-metálico   (nacarado, resínoso, vítreo)", "Verde-amarelado a verde-escuro. Base lozangular. Cristais prismáticos estriados paralelamente ao comprimento"}, 
                                    ...
                                    {"Espodumênio", "6 - 7", "3.50", "Inossilicatos        (cadeia simples)", "LiAlSi2O6", "Monoclínico", "Translúcido", "Perfeita[2]{110}", "Incolor", "Não-metálico", "Grupo: Piroxênios. Branco,cinzento, róseo, verde. Em cristais prismáticos achatados, estriados verticalmente. Também maciço"}, 
                                    {"Fluorita", "4", "3.40", "Haleto", "CaF2", "Isométrico", "Translúciodo", "Perfeita[4]", "Incolor", "Não-metálico", "Verde e cores variadas. Em cristais cubicos geminados por penetração"}, //mohs
                                    ...
                                    {"Illita", "1 - 2", "2.60", "Filossilicatos", "(K, H3)(Al, Mg, Fe)2(Si, Al)4[(OH)2, (H2O)]", "Monoclínico", "Translúcido", "Perfeita[1]", "Branco", "Não-metálico   (fosco, terroso)", "(argilomineral)cinza. Forma agregados de cristais"}, 
                                    ...
                                    {"Olivina", "6.5 - 7", "3.00", "Nesossilicatos", "(Mg,Fe)2SiO4", "Ortorrômbico", "Translúcido", "Imperfeita[2]", "Incolor", "Não-metálico   (resinoso, gorduroso, vítreo)", "Verde-Oliva a verde-acinzentado. Usualmente granulos disseminados em rochas ígneas"},
                                    ...
                                    {"Piroxênios", "5 - 6", "3.20", "Inossilicatos        (cadeia simples)", "Silicatos de Ca, Mg e Fe", "Ortorrômbico/     Monoclínico", "Transparente/     Translúcido", "Perfeita[2]", "Varíavel", "Não-metálico  (vítreo)", "Grupo de 24 minerais. Branco, preto, verde. Prismas grossos de secção transversal retãngular. Caracteriazdo pela clivagem"}, 
                                    ...
                                    {"Romanechita", "5 - 5.5", "6.56", "Óxido", "(BaH2O)2(Mn^4, Mn^3)5 O10", "Monoclínico", "Opáco", "Ausente", "Preto", "Submetálico", "Castanho escuro a preto. Maciço compacto, botroidal e estactítico"},
                                    ...
                                    {"Topázio", "8", "3.50", "Nesossilicatos", "Al2SiO4(F,Oh)2", "Ortorrômbico", "Translúcido", "Perfeita[1]", "Incolor", "Não-metálico  (vítreo)", "Cores váriadas. Cristais bem formados, com faces prismáticas"}, //mohs
                                    {"Turmalina", "7 - 7.5", "3.10", "Ciclossilicatos", "Grupo de borossilicatos de Na, Ca, Al, Mg, Fe e Mn", "Hexagonal", "Translúcido", "Ausente", "Incolor", "Não-metálico  (resínoso, vítreo)", "Preto e cores variadas. prismáticos com várias faces, estriado verticalmente"}};
        ...
        for(int i=0; i<40; i++)//button
        {
            for(int j=0; j<40; j++)//titulos
            {
                if(gemButtons[i].GetComponent<GemButton>().title == mineralList[j,0])
                {
                    ...
                    gemButtons[i].GetComponent<GemButton>().other = mineralList[j,10];
                }
            }
        }
    }
